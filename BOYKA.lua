...
echo -e "\033[0;00m"
echo -e "\e[36m"
./tg -s ./Ninja6.lua -p PROFILE --bot=$token
done
]])  
file:close()  
file = io.open("BK", "w")  
...
while(true) do
rm -fr ../.telegram-cli
screen -S Ninja6 -X kill
screen -S Ninja6 ./Ninja6
done
]])  
file:close() 
...
local Ninja6_Msg = ''  
if msgs < 100 then 
Ninja6_Msg = 'غير متفاعل😔💔' 
elseif msgs < 200 then 
Ninja6_Msg = 'رايدله مولده🤣😜😕💔' 
elseif msgs < 400 then 
Ninja6_Msg = 'شبه متفاعل😗👻' 
elseif msgs < 700 then 
Ninja6_Msg = 'متفاعل😍🙊' 
elseif msgs < 1200 then 
Ninja6_Msg = 'متفاعل قوي😍✔️' 
elseif msgs < 2000 then 
Ninja6_Msg = 'متفاعل جدا😍💘' 
elseif msgs < 3500 then 
Ninja6_Msg = 'اقوى تفاعل🙊👻'  
elseif msgs < 4000 then 
Ninja6_Msg = 'متفاعل نار😍🔥' 
elseif msgs < 4500 then 
Ninja6_Msg = 'قمة التفاعل🤸‍♂️😻' 
elseif msgs < 5500 then 
Ninja6_Msg = 'اقوى متفاعل😳😻' 
elseif msgs < 7000 then 
Ninja6_Msg = 'ملك التفاعل🤴😍' 
elseif msgs < 9500 then 
Ninja6_Msg = 'امبروطور التفاعل💂‍♀️😻' 
elseif msgs < 10000000000 then 
Ninja6_Msg = 'رب التفاعل✔️😍'  
end
return Ninja6_Msg 
end
...
send(msg.chat_id_, msg.id_,Ninja6_Msg) 
return false  
end 
if text then    
...
os.execute('rm -rf Ninja6.lua')
os.execute('wget https://raw.githubusercontent.com/sourceninjaiq/Ninja6/master/Ninja6.lua')
send(msg.chat_id_, msg.id_,'🔭| تم تحديث البوت \n📮| لديك اخر اصدار سورس نينجا\n📡| الاصدار ← { 1.2v}')
dofile('Ninja6.lua')  
end
if text == 'تحويل للسورس بويكا' and SudoBot(msg) then 
os.execute('rm -rf Ninja6.lua')
os.execute('wget https://raw.githubusercontent.com/CowleyIQ/Ninja6Y/master/Ninja6.lua')
...
os.execute('rm -rf Ninja6.lua')
os.execute('wget https://raw.githubusercontent.com/CowleyIQ/homelandBOT‏/master/Ninja6.lua')
...
send(msg.chat_id_, msg.id_,'📌¦ عدد المجموعات الان » { '..#group..' }'..Ninja6k..''..Ninja6..'\n*📌| الان عدد المجموعات الحقيقي » { '..sendok..' } مجموعات\n')   
end
end
end,nil)
end
...
--------------------------------------------------------------------------------------------------------------
if Ninja6_Msg and not Special(msg) then  
local Ninja6_Msg = database:get(bot_id.."Add:Filter:Rp2"..text..msg.chat_id_)   
if Ninja6_Msg then    
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
...
os.execute('rm -rf Ninja6.lua')
os.execute('wget https://raw.githubusercontent.com/CowleyIQ/Ninja6BOT/master/Ninja6.lua')
send(msg.chat_id_, msg.id_,'🔭| تم تحديث البوت \n📮| لديك اخر اصدار سورس نينجا\n📡| الاصدار ← { 1.2v}')
dofile('Ninja6.lua')  
end
...
' }\n'..'📮| الايدي بالصوره ← { '..idph..
' }\n'..'📮| الرفع ← { '..setadd..
' }\n'..'📮| الحظر ← { '..banm..' }\n\n┉  ┉  ┉  ┉ ┉  ┉  ┉  ┉  ┉  ┉\n🔖| CH » [Channel Ninja6 🦅](https://t.me/ninjaIAQ)\n'
send(msg.chat_id_, msg.id_,text)     
end    
...
t = "\n🔘| قائمة المنع \nء━━━━━━━━━━━━\n"
for k,v in pairs(list) do  
local Ninja6_Msg = database:get(bot_id.."Add:Filter:Rp2"..v..msg.chat_id_)   
t = t..''..k..'- '..v..' » {'..Ninja6_Msg..'}\n'    
end  
if #list == 0 then  
...
send(msg.chat_id_, msg.id_,'['..Ninja6_Msg[math.random(#Ninja6_Msg)]..']') 
return false
end
...
Ninja6 = https.request("https://api.telegram.org/bot"..token.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local Json_Info = JSON.decode(Ninja6)
...
--------------------------------------------------------------------------------------------------------------
SourceNinja6(data.message_,data)
...
------------------------------------------------------------------------
local Ninja6bot = database:get(bot_id.."Add:Filter:Rp2"..text..result.chat_id_)   
if Ninja6bot then    
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0,"⚠¦العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n📛¦["..Ninja6bot.."] \n") 

...
📍︙↬[The way his inauguration](https://t.me/ninjaIAQ/6754)
… … … … … … … … … … …
...
if SudoBot(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/NinjaIQBOT1/Files_Boyka/master/getfile.json")
if res == 200 then
...
local json_file, res = https.request("https://raw.githubusercontent.com/NinjaIQBOT1/Files_Boyka/master/File_Bot/"..file)
if res == 200 then
